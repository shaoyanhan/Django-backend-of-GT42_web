...
cursor.execute("ALTER TABLE mosaic_tpm ADD INDEX idx_mosaicID (mosaicID);")

# 读取数据文件并插入数据
# data_file = './testData/tpm/mosaic_tpm_table.tsv'
data_file = './table_for_mysql/mosaic_tpm_table.tsv'
with open(data_file, newline='', encoding='utf-8') as csvfile:
    ...
    for line in reader:
        if len(line) == 63:
            ...
            insert_sql = " INSERT INTO mosaic_tpm (mosaicID, Ca1_1, Ca1_2, Ca1_3, Ca2_1, Ca2_2, Ca2_3, Ca3_1, Ca3_2, Ca3_3, Ro1_1, Ro1_2, Ro1_3, Ro2_1, Ro2_2, Ro2_3, Le1_1, Le1_2, Le1_3, LS1_1, LS1_2, LS1_3, Bu1_1, Bu1_2, Bu1_3, In1_1, In1_2, In1_3, NR1_1, NR1_2, NR1_3, AM_1, AM_2, AM_3, Bu2_1, Bu2_2, Bu2_3, Sp_1, Sp_2, Sp_3, Br_1, Br_2, Br_3, St_1, St_2, St_3, Pi_1, Pi_2, Pi_3, Gl_2, Gl_3, LS2_2, LS2_3, In2_1, In2_3, No2_1, No2_2, No2_3, Bu3_1, Bu3_3, Le2_1, Le2_2, Le2_3) VALUES ( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
